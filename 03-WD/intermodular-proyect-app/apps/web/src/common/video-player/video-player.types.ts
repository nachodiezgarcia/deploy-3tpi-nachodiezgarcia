...
export type SetVideoPlayerState = (
  newState: VideoPlayerState | ((prev: VideoPlayerState) => VideoPlayerState),
) => void;
...
export type TapZoneHandler = (
  action: string | undefined,
  tapCount: number,
) => void;
export type OnTapZone = (
  tapZoneHandler: TapZoneHandler,
